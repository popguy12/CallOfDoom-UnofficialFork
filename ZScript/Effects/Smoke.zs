...
class COD_Smoke : Actor abstract
{
	...
	Default
	{
		COD_Smoke.GrowSpeed 0.00275, 0.003;
		COD_Smoke.FadeSpeed 0.00275, 0.003;
		COD_Smoke.StopSpeed 0.95, 0.95;
		COD_Smoke.GrowStopFactor 0.98;
		Radius 5;
		Height 10;
		Scale 0.02;
		Gravity 0.022;
...
class COD_ExplosionSmoke : COD_Smoke
{
	Default
	{
		Scale 0.4;
		COD_Smoke.FadeSpeed 0.003, 0.007;
		COD_Smoke.GrowSpeed 0.006, 0.010;
		COD_Smoke.StopSpeed 0.80, 0.88;
	}
